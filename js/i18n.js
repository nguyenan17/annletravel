(function () {
    ...
    const translations = {
        vi: {
            nav: { home: 'Trang chủ', tours: 'Tour', destinations: 'Điểm đến', services: 'Dịch vụ', business: 'Doanh nghiệp', about: 'Về chúng tôi', contact: 'Liên hệ', consult: 'Tư vấn ngay', blog: 'Blog' },
        ...
        en: {
            nav: { home: 'Home', tours: 'Tours', destinations: 'Destinations', services: 'Services', business: 'Business', about: 'About us', contact: 'Contact', consult: 'Get advice', blog: 'Blog' },
    ...
    const autoPairs = {
        'Trang chủ': 'Home', 'Tour': 'Tours', 'Điểm đến': 'Destinations', 'Dịch vụ': 'Services', 'Doanh nghiệp': 'Business', 'Về chúng tôi': 'About us', 'Liên hệ': 'Contact', 'Tư vấn ngay': 'Get advice', 'Blog': 'Blog',
