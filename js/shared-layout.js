...
(function () {
    ...
    if (!document.querySelector('link[href*="css/audience.css"]')) {
        const audienceCss = document.createElement("link");
        audienceCss.rel = "stylesheet";
        audienceCss.href = "css/audience.css";
        document.head.appendChild(audienceCss);
    }
    ...
    if (footer) {
        footer.innerHTML = `
            <div class="container footer-container">
                <div>
                    <a href="${isBusiness ? "business.html" : "ca-nhan.html"}" class="footer-logo-link"><img src="images/logo.png" class="footer-logo-image" alt="ANNLETRAVEL"></a>
                    <p>CÔNG TY TNHH DỊCH VỤ VÀ DU LỊCH ANN LÊ.</p>
                </div>
                <div>
                    <h4>Khám phá</h4>
                    <a href="${isBusiness ? "business.html#businessServices" : "tours.html"}">${isBusiness ? "Giải pháp doanh nghiệp" : "Tất cả tour"}</a>
                    <a href="destinations.html">Điểm đến</a>
                    <a href="${isBusiness ? "business.html" : "services.html"}">${isBusiness ? "Trang doanh nghiệp" : "Dịch vụ"}</a>
    ...
    style.textContent = `
        ...
        .audience-header .language-switcher{display:flex;align-items:center}
        ...
        .footer-logo-link{display:inline-flex;align-items:center;margin-bottom:10px}.footer-logo-image{width:74px;height:74px;object-fit:contain;display:block}
        .footer-container>div:nth-child(2) a{display:block;margin:5px 0;color:rgba(255,255,255,.68);font-size:14px}
        @media(max-width:1100px){.audience-header .menu>a,.audience-header .menu>.nav-dropdown>a{padding:0 8px;font-size:11px}.public-header-actions{gap:5px}.audience-header .audience-switch-btn{min-width:auto;padding:9px 11px}.audience-header .btn-header{padding:9px 12px!important}}
        @media(max-width:820px){.public-header-actions .audience-switch-btn{display:none}.audience-header .header-container{flex-wrap:wrap}.audience-header .menu{order:3;width:100%;justify-content:flex-start;overflow-x:auto;padding-bottom:5px;scrollbar-width:none}.audience-header .menu::-webkit-scrollbar{display:none}.audience-header .menu>a,.audience-header .menu>.nav-dropdown>a{font-size:13px;min-height:40px;flex-shrink:0}.audience-header .btn-header{display:none!important}.audience-header .language-switcher{order:2}}
        @media(max-width:650px){.audience-header .header-container{min-height:76px;padding:8px 0}.audience-header .logo img{width:58px;height:58px}.audience-header .menu{gap:8px}.audience-header .menu>a,.audience-header .menu>.nav-dropdown>a{font-size:13px;padding:0 8px}.audience-header .language-switcher{display:none}.footer-logo-image{width:62px;height:62px}}
    `;
    document.head.appendChild(style);

    if (typeof window.renderDestinationMenu === "function") window.renderDestinationMenu();
})();
